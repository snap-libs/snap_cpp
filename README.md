...
* [공식 웹사이트 (종합 쇼케이스)](https://snap-libs.github.io/snap/)
...
* [Hugging Face Space 바로가기](https://huggingface.co/spaces/softguy777/snap-demo)
...
* [Hugging Face Space 바로가기](https://huggingface.co/spaces/softguy777/snap_voice_demo)

### Piper VITS 음성 합성 (경량 온디바이스형)
BERT를 내장하지 않은 TTS와의 연동 예제입니다. 기존에 사용하던 espeak-ng를 SNAP으로 대체하여 22개 화자 스타일의 한국어 음성을 지원합니다.
* [Hugging Face Space 바로가기](https://huggingface.co/spaces/softguy777/snap_voice_demo2)
...
* [Hugging Face Space 바로가기](https://huggingface.co/spaces/softguy777/snap_voice_demo3)

## SNAP Cloud API (Free)

현재 SNAP 한국어 전처리 기능 테스트를 위해 별도의 가입이나 조건 없이 자유롭게 호출할 수 있도록 오픈되어 있습니다. (일본어 등 다국어 API는 순차적으로 추가될 예정입니다.)
...
curl -X POST "https://snap-api-673324870645.asia-northeast3.run.app/v1/normalize" \
     ...
     -d '{
       ...
       "custom_dict": {"ChatGPT": "챗지피티"}
     }'
```

### 상세 연동 문서
* [REST API 연동 상세 매뉴얼](SNAP_REST_API_MANUAL.md) — 파라미터 규격, 응답 스키마, Python/JavaScript 호출 예제
* [AI Agent용 MCP Server 가이드](https://github.com/snap-libs/snap_api/blob/main/mcp_server/README.md) — Cursor, Claude Desktop 등 AI 에이전트 연동
