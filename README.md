...
[🌐 Official Website](https://snap-libs.github.io/snap/) | [📦 C++ SDK Setup Guide](https://github.com/snap-libs/snap_cpp/blob/main/INSTALL.md) | [📘 C++ API Manual](https://github.com/snap-libs/snap_cpp/blob/main/SNAP_API_MANUAL.md) | [🎛️ TUI Setup Manager Guide](https://github.com/snap-libs/snap_core/blob/main/setup/SNAP_SETUP_MANUAL.md)
...
snap_handle_t handle = snap_init("models/ko/model_index.json");
...
engine = snap.Engine(config_path="models/ko/model_index.json")
