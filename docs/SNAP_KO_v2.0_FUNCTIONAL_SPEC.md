...
대한민국 국립국어원 『표준 발음법』(문화체육관광부 고시 제2017-13호) 총 7개 장 30개 전수 조항에 대한 SNAP 한국어 v2.0 지원 규정 및 발음 매핑 상세표입니다. 코어 엔진 소스([`snap_cpp/src/phonology_ko.cpp`](../snap_cpp/src/phonology_ko.cpp))와 1:1로 대응됩니다.
